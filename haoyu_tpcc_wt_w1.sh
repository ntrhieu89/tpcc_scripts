...
do
	...
	do
		...
		do
			...
			cmd="bash $bench/tpcc_runbench_wt.sh $cache $cli $dir $ar $batch $cache_instance $threads $warehouses $arsleep 1 1 1.0 $rep $storesess $parallel $persistMode $manualwarmup"
			echo $cmd
